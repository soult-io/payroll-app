// Mutation testing for apps/server/src/deposits (PAY-93, PAY-108). Run with
// `pnpm mutation:server-deposits` from the repo root; see CONTRIBUTING.md.
...
export default strykerConfig("deposits");
