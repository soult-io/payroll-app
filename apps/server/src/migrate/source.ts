/**
 * Legacy source reader — the `accounting` schema in `second_brain`
 * (mcp-accounting, stack-finance). Raw SQL against an injectable executor so
 ...
 *
 * Column names below mirror the source DDL verbatim
 * (stack-finance/mcp-accounting/src/db.ts). Money arrives as NUMERIC strings;
...
export interface SourceData {
  ...
  /** Runs carrying a pay_stub_path (files stay in Nextcloud — D5). */
