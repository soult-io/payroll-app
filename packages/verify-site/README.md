...
## Serving
`Dockerfile` builds `ghcr.io/soult-io/wagon-payroll-verify` (the legacy
`ghcr.io/soult-io/payroll-app-verify` received tags up to `v1.25.0` and receives
nothing after it; its old tags stay pullable) — an unprivileged
